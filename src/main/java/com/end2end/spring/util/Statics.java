...
public class Statics {
    // 출퇴근 관리 시간 지정
    public static final int WORK_ON_CHECK_TIME = 10;
    ...
    // API 서비스키
    public static final String apiServiceKey =  "NWIrVZ45vQRGOrgG1lzJk3edmMTejzwM6zNqwKU8dfW8dfsoyWiQ9pKZi0HfpkxbUxqyLGFSVJM8SESuqt1L5w%3D%3D";

    // 설정된 회사 IP
    public static final String COMPANY_IP = "";
}
